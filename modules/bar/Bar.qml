    ...
    Item {
        ...
        StyledRect {
            ...
            MouseArea {
                ...
                onWheel: event => {
                    // Simplified workspace switching for niri
                    if (event.angleDelta.y < 0 || Niri.activeWsId > 1)
                        Niri.dispatch(`focus-workspace ${event.angleDelta.y > 0 ? Niri.activeWsId - 1 : Niri.activeWsId + 1}`);
                }
            }
